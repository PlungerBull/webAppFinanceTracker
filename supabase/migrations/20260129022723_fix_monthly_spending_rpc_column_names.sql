-- Fix RPC functions to use amount_home_cents instead of deprecated amount_home
-- This aligns with the Sacred Ledger BIGINT cents migration

-- Fix version 1: (p_months_back, p_user_id)
...
-- Fix version 2: (p_user_id, p_months_back)
CREATE OR REPLACE FUNCTION "public"."get_monthly_spending_by_category"(
  "p_user_id" "uuid",
  "p_months_back" integer DEFAULT 6
) RETURNS TABLE(
