-- ============================================================================
-- MIGRATION: Fix import_transactions timeout on PROD
-- Purpose: Add function-level statement timeout for large imports
-- Date: 2026-01-04
-- ============================================================================
-- Context: Processing 3551 transactions exceeds PROD's 60s default timeout
-- Solution: Set function-level timeout to 5 minutes for large batch imports
-- ============================================================================
...
SET statement_timeout TO '300000'  -- NEW: 5 minutes (300000ms) instead of default 60s
AS $$
DECLARE
  v_transaction jsonb;
  v_date date;
